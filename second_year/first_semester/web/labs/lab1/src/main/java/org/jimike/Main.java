...
import org.jimike.model.ServerResponse;
import org.jimike.utility.ParamsParser;
import org.jimike.utility.RequestChecker;
...
public class Main {
    ...
    public static void main(String[] args) throws JsonProcessingException {
        ...
        while (new FCGIInterface().FCGIaccept() >= 0) {
            ...
            try {
                ClientRequest request = ParamsParser.parseRequest(params);
